...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        long milliseconds = mCursor.getLong(MainActivity.INDEX_WEATHER_DATE);
        String date = SunshineDateUtils.getFriendlyDateString(mContext, milliseconds, false);
        ...
        String temperature = SunshineWeatherUtils.formatHighLows(mContext, high, low);
        String summary = date + " - " + description + " - " + temperature;
