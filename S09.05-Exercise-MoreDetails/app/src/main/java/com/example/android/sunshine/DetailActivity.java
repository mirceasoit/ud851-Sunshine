...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, weatherConditionId);
        mDescriptionView.setText(description);
        // COMPLETED (28) Display the high temperature
        double highTemperature = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String highTemperatureString = SunshineWeatherUtils.formatTemperature(this, highTemperature);
        mHighTemperatureView.setText(highTemperatureString);
        // COMPLETED (29) Display the low temperature
        double lowTemperature = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowTemperatureString = SunshineWeatherUtils.formatTemperature(this, lowTemperature);
        mLowTemperatureView.setText(lowTemperatureString);
        ...
        mForecastSummary = String.format("%s - %s - %s/%s",
                dateText, description, highTemperatureString, lowTemperatureString);
    }
